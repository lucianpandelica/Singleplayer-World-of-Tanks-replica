...
namespace implemented
{
    class CameraTema2
    {
     public:
        ...
        CameraTema2(const glm::vec3 &position, const glm::vec3 &center, const glm::vec3 &up, float distanceToTarget)
        {
        ...
        // Update camera
        void Set(const glm::vec3& position, const glm::vec3& center, const glm::vec3& up, float distanceToTarget)
        {
